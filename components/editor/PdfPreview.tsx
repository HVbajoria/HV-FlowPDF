...
export const PdfPreview: React.FC<PdfPreviewProps> = ({
  ...
  useEffect(() => {
    ...
    const renderPdf = async () => {
      ...
      try {
        ...
        if (cancelled || !canvas) return; // Double check after async operations
        ...
        // Fill background with white to handle transparent PDFs
  ...
  return <canvas ref={canvasRef} className="max-w-full h-auto shadow-sm" style={{ display: 'block' }} />;
};